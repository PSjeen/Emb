...
static int __init ModuleInit(void) {
	...
	if (gpio_request(3, "rpi-gpio-3")) {
		printk("Can not allocate GPTO 3\n");
		goto AddError;
	}
	...
	if (gpio_request(4, "rpi-gpio-4")) {
		printk("Can not allocate GPTO 4\n");
		goto AddError;
	}
	...
	if (gpio_request(17, "rpi-gpio-17")) {
		printk("Can not allocate GPTO 17\n");
		goto AddError;
	}
	...
	if (gpio_request(21, "rpi-gpio-21")) {
		printk("Can not allocate GPTO 21\n");
		goto AddError;
	}
	...
	if (gpio_request(20, "rpi-gpio-20")) {
		printk("Can not allocate GPTO 20\n");
		goto AddError;
	}
	...
	if (gpio_request(16, "rpi-gpio-16")) {
		printk("Can not allocate GPTO 16\n");
		goto AddError;
	}
	...
	if (gpio_request(12, "rpi-gpio-12")) {
		printk("Can not allocate GPTO 12\n");
		goto AddError;
	}
	...
	if (gpio_request(7, "rpi-gpio-7")) {
		printk("Can not allocate GPTO 7\n");
		goto AddError;
	}
	...
	if (gpio_request(8, "rpi-gpio-8")) {
		printk("Can not allocate GPTO 8\n");
		goto AddError;
	}
	...
	if (gpio_request(25, "rpi-gpio-25")) {
		printk("Can not allocate GPTO 25\n");
		goto AddError;
	}
	...
	if (gpio_request(24, "rpi-gpio-24")) {
		printk("Can not allocate GPTO 24\n");
		goto AddError;
	}
